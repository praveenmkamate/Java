...
import static board.Dice.Directions.RIGHT;
...
class PirateTest {
    ...
    void testObstacleConditionOneForward() {
        ...
        board.setObstacleOnBoard(1,3, PIRATE);
        ...
        assertTrue(board.getBoardCell(1, 3).getObstacle() instanceof Pirate);
    ...
    void testObstacleConditionTwoForward() {
        ...
        board.setObstacleOnBoard(0,3, PIRATE);
        testPlayer.setScore(100);
        ...
        // Checking if boardcell has obstacle
        assertTrue(board.getBoardCell(0, 3).getObstacle() instanceof Pirate);

        // Checking if score was deducted as intended.
        assertTrue(testPlayer.getScore() == 50);
    ...
    void testObstacleConditionOneLeft() {
        ...
        board.setObstacleOnBoard(2,2, PIRATE);
        testPlayer.setScore(100);
        ...
        // Checking if boardcell has obstacle
        assertTrue(board.getBoardCell(2, 2).getObstacle() instanceof Pirate);
    ...
    void testObstacleConditionTwoLeft() {
        ...
        board.setObstacleOnBoard(2,1, PIRATE);
        testPlayer.setScore(100);
        ...
        // Checking if boardcell has obstacle
        assertTrue(board.getBoardCell(2, 1).getObstacle() instanceof Pirate);
    ...
    void testObstacleConditionOneRight() {
        ...
        board.setObstacleOnBoard(2,4, PIRATE);
        testPlayer.setScore(100);
        ...
        // Checking if boardcell has obstacle
        assertTrue(board.getBoardCell(2, 4).getObstacle() instanceof Pirate);
    ...
    void testObstacleConditionTwoRight() {
        ...
        board.setObstacleOnBoard(2,5, PIRATE);
        testPlayer.setScore(100);
        ...
        // Checking if boardcell has obstacle
        assertTrue(board.getBoardCell(2, 5).getObstacle() instanceof Pirate);
    ...
    void testObstacleConditionOneBack() {
        ...
        board.setObstacleOnBoard(3,3, PIRATE);
        testPlayer.setScore(100);
        ...
        // Checking if boardcell has obstacle
        assertTrue(board.getBoardCell(3, 3).getObstacle() instanceof Pirate);
    ...
    void testObstacleConditionTwoBack() {
        ...
        board.setObstacleOnBoard(4,3, PIRATE);
        testPlayer.setScore(100);
        ...
        // Checking if boardcell has obstacle
        assertTrue(board.getBoardCell(4, 3).getObstacle() instanceof Pirate);
